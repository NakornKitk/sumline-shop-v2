  ...
  return (
    ...
    >
      <div className="py-[100px] px-[20px] bg-[#F5F5F5]">
        <p className="text-[26px] font-semibold text-center text-black">MY ACCOUNT</p>
      ...
      <div className="py-[120px] flex justify-center w-[100%] gap-x-[30px]">
        <div className="w-[49%]">
          ...
          <form className="py-[5px]">
            ...
            <button className="text-white bg-[#A49C8E] hover:bg-[#777064] p-[8px] text-[12px] font-bold my-[5px]" onClick={() => alert("This function is not avaliable")}>LOGIN</button>
          </form>
        ...
        <div className="w-[49%]"> 
          ...
          <form className="py-[5px]">
            ...
            <button className="text-white bg-[#A49C8E] hover:bg-[#777064] p-[8px] text-[12px] font-bold my-[5px]" onClick={() => alert("This function is not avaliable")}>REGISTER</button>
          </form>
        </div>
      </div>
  </div>
